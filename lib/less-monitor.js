...
var LessMonitor = new Class({
	...
	init: function() {
		...
		this.options.ignore = this.options.ignore.replace( /\\/g, '/' );
	...
	getRelativePath: function( file ) {
		return path.relative( this.options.directory, file ).replace( /\\/g, '/' );
	},
...
exports = module.exports = new LessMonitor();
exports.version = '0.1';